...
<link rel="stylesheet" type="text/css"
	href="/instagram/common/css/instagram_sidebar.css">
</head>
<body>
	<%
	...
	<div class="navbar">
		<div class="nav-wrapper">
			<a href="/instagram/main.do"> <img
				src="/instagram/images/logo.png" class="brand-img" alt="logo">
			</a>
			<div class="nav-items">
				...
				<div class="nav-items-box">
					<a href="#">
						<div class="nav-items-detail"
							onclick="location.href='/instagram/main/exploration'">
							<div class="nav-items-img">
								<img src="/instagram/images/explore.png" id="search"
									class="icon" alt="">
							</div>
				...
				<div class="nav-items-box">
					<a href="#">
						<div class="nav-items-detail"
							onclick="location.href='/instagram/main/DM'">
							<div class="nav-items-img">
				...
				<div class="nav-items-box">
					<a href="#">
						<div class="nav-items-detail"
							onclick="location.href='/instagram/view/login'">
				...
				<div class="nav-items-box">
					<a href="#">
						<div class="nav-items-detail"
							onclick="location.href='/instagram/logout.do'">
							<div class="nav-items-img" id="user_profile">
								<div class="user_profile_img">
									<img src="/instagram/images/logout.png" class="icon" alt="">
								</div>
							</div>
				...
				<div class="nav-items-box">
					<a href="#">
						<div class="nav-items-detail"
							onclick="location.href='/instagram/myprofile?pageType=my'">
							<div class="nav-items-img" id="user_profile">
								<div class="user_profile_img">
									<img src="/instagram/images/profile-pic.png" class="icon"
										alt="">
								</div>
							</div>
				...
				<div class="nav-items-box">
					<a href="#">
						<div class="nav-items-detail"
							onclick="location.href='/instagram/member/update'">
							<div class="nav-items-img" id="user_profile">
								<div class="user_profile_img">
									<img src="/instagram/images/profile-pic.png" class="icon"
										alt="">
				...
				<div class="nav-items-box">
					<a href="#">
						<div class="nav-items-detail"
							onclick="location.href='/instagram/member/delete.do'">
							<div class="nav-items-img" id="user_profile">
								<div class="user_profile_img">
									<img src="/instagram/images/profile-pic.png" class="icon"
										alt="">
