		...
		<div class="wrapper">
			...
			<div class="left-col">
				...
				<div class="post">
					<div class="info">
						...
						<div>
							<img src="/instagram/images/option.png" class="options"
								id="<%=board.getBoardId()%>"
								name="boardwriter<%=board.getWriterId()%>" alt="">
						</div>
					</div>
					<%
					...
					%>
					<img src="/instagram/upload/<%=boardfile.getStoreFilename()%>"
					...
					<div class="post-content">
						<div class="reaction-wrapper">
							<a
								href="/instagram/like_insert.do?boardId=<%=board.getBoardId()%>&userId=<%=loginUser.getId()%>">
								<%
								...
								id="likeHeart" alt="">
							</a> <img src="/instagram/images/comment.png" class="con-modal-open"
								id="con<%=board.getBoardId()%>" name="<%=board.getWriterId()%>"
								value="<%=loginUser.getId()%>" alt=""> <img
								src="/instagram/images/send.png" class="icon" alt=""> <img
								src="/instagram/images/save.png" class="save icon" alt="">
						</div>
						<p class="likes"><%=board.getLike_count()%>likes
						</p>
						<p class="description">
							<span> <%
 for (int m = memberlistsize; m >= 0; m--) {
 ...
 %>
					...
					<div class="comment-wrapper">
						...
						<form action="/instagram/comment/insert.do" method="get"
							...
							<input type="text" class="comment-box" name="content"
								placeholder="Add a comment"> <input type="hidden"
								name="board_id" value="<%=board.getBoardId()%>"> <input
								type="hidden" name="user_id" value="<%=loginUser.getId()%>">
